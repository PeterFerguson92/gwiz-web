...
const faqs: FAQType[] = [
  {
    ...
    answer:
      "We understand that navigating the world of electricity services can <br> be daunting, which is why we've compiled this comprehensive.",
  },
  {
...
export { blogs, caseStudies, faqs, teamMembers, testimonials };
