...
export const caseFaqs: FAQType[] = [
  {
    ...
    answer:
      "We're your trusted partner in all things electrical. From initial consultation to ongoing support, we're committed to providing you with the highest level.",
    duration: 800,
  },
  {
